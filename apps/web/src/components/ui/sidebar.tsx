  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "bg-background", state === "expanded" ? "bg-sidebar!" : null,
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width,background] duration-200 ease-linear md:flex",
          side === "left"

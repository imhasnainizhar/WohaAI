...
export const EXPIRATION = {
  ...
  ACCESS_SESSION_COOKIE: 45 * 60 * 1000,
  JWT_PRIVATE_ACCESS_SESSION_TOKEN: "10m",
  PRIVATE_ACCESS_SESSION_COOKIE: 10 * 60 * 1000,
  JWT_REFRESH_SESSION_TOKEN: "365d",
  REFRESH_SESSION_COOKIE: 365 * 25 * 60 * 60 * 1000,
  JWT_SIGNUP_SESSION_TOKEN: "10m",
  SIGNUP_SESSION_COOKIE: 10 * 60 * 1000,
  REDIS_SIGNUP_SESSION_TTL: 10 * 60,
  JWT_SIGNUP_SESSION_TOKEN_EXTENDED: "30m",
  SIGNUP_SESSION_COOKIE_EXTENDED: 30 * 60 * 1000,
  REDIS_SIGNUP_SESSION_TTL_EXTENDED: 30 * 60,
  JWT_SIGNIN_SESSION_TOKEN: "10m",
  SIGNIN_SESSION_COOKIE: 10 * 60 * 1000,
  REDIS_SIGNIN_SESSION_TTL: 10 * 60,
};

...
export type CardWhereInput = {
  ...
  cardId?: Prisma.StringFilter<"Card"> | string
...
export type CardScalarWhereWithAggregatesInput = {
  ...
  cardId?: Prisma.StringWithAggregatesFilter<"Card"> | string
...
export type CardOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"cardId" | "userID", ExtArgs["result"]["card"]>
...
export interface CardDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const cardWithCardIdOnly = await prisma.card.findMany({ select: { cardId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Cards and only return the `cardId`
   * const cardWithCardIdOnly = await prisma.card.createManyAndReturn({
   *   select: { cardId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Cards and only return the `cardId`
   * const cardWithCardIdOnly = await prisma.card.updateManyAndReturn({
   *   select: { cardId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CardFieldRefs {
  readonly cardId: Prisma.FieldRef<"Card", 'String'>

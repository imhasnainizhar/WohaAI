...
import { verifyUserEmailSchema } from '@schemas/email_verification';
...
export const validateDisplayNameController = async (req: Request, res: Response) => {
  try {
    ...
    const result = await validateDisplayNameService(signupSessionID, firstName, lastName);
...
export const validateEmailController = async (req: Request, res: Response) => {
  try {
    ...
    const result = await validateEmailService(signupSessionID, email);
...
export const validatePasswordController = async (req: Request, res: Response) => {
  try {
    ...
    const result = await validatePasswordService(signupSessionID, password, confirmPassword);
